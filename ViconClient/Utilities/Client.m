...
%% GetCentroidPosition
    function [Output] = GetCentroidPosition( obj, CameraName, CentroidIndex )
      ...
      vAccuracy   = 0;
      pAccuracy   = libpointer( 'doublePtr', vAccuracy ); 

      % Call function
      calllib( 'ViconDataStreamSDK_MATLAB', 'GetCentroidPosition_v2', obj.InstanceID, CameraName, CentroidIndex, pPosition, pRadius, pAccuracy, pResult );
      ...
      cAccuracy   = get( pAccuracy, 'Value' );
            
      Output = struct( 'Result', cResult, 'Position', cPosition, 'Radius', cRadius, 'Accuracy', cAccuracy);
